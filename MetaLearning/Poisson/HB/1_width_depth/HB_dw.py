...
class PINNModel:
    ...
    def eval_config(self, config):
        ...
        sys.stdout.flush()
        obj = self.eval_nn_performance(node_per_layer, num_layer)
        return {
            "obj": obj,
            "config": config,
        }

    def eval_nn_performance(self, node_per_layer, num_layer):
        ...
        error = main_fun(num_try=1, width=node_per_layer, depth=num_layer, iter_num=50000, learning_rate=5.0e-4)
        return error
