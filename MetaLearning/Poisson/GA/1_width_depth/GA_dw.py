...
# Define population.
indv_template = BinaryIndividual(ranges=[(20, 60), (2, 8)], eps=0.001)
...
def eval_nn_performance(node_per_layer, num_layer):
    ...
    f = open("./dw_cmd_100.txt", "a")
    f.write('python run_GA.py %d %d\n' % (node_per_layer, num_layer))
    start_time = datetime.now()
    value = main_fun(num_try=1, width=node_per_layer, depth=num_layer, iter_num=50, learning_rate=5.0e-4)
