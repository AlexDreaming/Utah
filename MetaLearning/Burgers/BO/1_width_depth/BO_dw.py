...
if __name__ == "__main__":
    ...
    bo = BayesianOptimization(
        lambda node_per_layer, num_layer: eval_NN_performance(node_per_layer, num_layer, data, max_iter),
        {'node_per_layer': (2, 50), 'num_layer': (2, 20)})
